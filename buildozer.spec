...
# (str) Package name
package.name = encryptorx

# (str) Package domain (needed for android/ios packaging)
package.domain = com.ghostmoai
...
source.exclude_dirs = tests, bin, venv, .venv, .git, .vscode, __pycache__, build, dist, tools, obfuscated_src, forze-decrytion
